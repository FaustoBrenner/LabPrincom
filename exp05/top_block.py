...
# Title: Top Block
# Generated: Wed Oct 21 10:43:35 2020
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.v = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fm, 2*Am, -Am)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.v.set_sampling_freq(self.samp_rate)

    def get_kvco(self):
        return self.kvco

    def set_kvco(self, kvco):
        self.kvco = kvco
    ...
    def set_Am(self, Am):
        self.Am = Am
        self.v.set_amplitude(2*self.Am)
        self.v.set_offset(-self.Am)
