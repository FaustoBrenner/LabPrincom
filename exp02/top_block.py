...
# Title: Top Block
# Generated: Fri Sep  4 17:46:54 2020
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._k_a_range = Range(0, 12, 1, 6, 200)
        self._k_a_win = RangeWidget(self._k_a_range, self.set_k_a, "k_a", "counter_slider", float)
        self.top_layout.addWidget(self._k_a_win)
        ...
        self.aba.addTab(self.aba_widget_0, "m(t)")
        ...
        self.aba.addTab(self.aba_widget_1, "s(t) e z(t)")
        ...
        self.aba.addTab(self.aba_widget_2, "cos(2pit/T)")
        ...
        self.aba.addTab(self.aba_widget_3, "Constellation")
        ...
        self.qtgui_time_sink_x_0_0_0_0.set_y_axis(-1.25, 1.25)
        ...
        self.aba_layout_2.addWidget(self._qtgui_time_sink_x_0_0_0_0_win)
        ...
        self.qtgui_time_sink_x_0_0_0.set_y_axis(-1.25, 1.25)
        ...
        self.aba_layout_0.addWidget(self._qtgui_time_sink_x_0_0_0_win)
        ...
        self.qtgui_const_sink_x_0.set_y_axis(-20, 20)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff((k_a, ))
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_add_const_vxx_0 = blocks.add_const_vff((8, ))
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, 1, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 1100, 2, -1)
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_throttle_0_0_0_0, 0))    
        ...
        self.connect((self.blocks_throttle_0_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))    
    ...
    def set_k_a(self, k_a):
        self.k_a = k_a
        self.blocks_multiply_const_vxx_0.set_k((self.k_a, ))
